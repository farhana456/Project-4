...
export default function HomeFour() {
  ...
  return (
    ...
    {/* <!-- #search --> */}
     ...
     <div id="page-wrapper" className="feed-view">
        ...
        <div className="slider-container">
            <div className="slider-container-row section" id="slider-posts">
                <div className="widget PopularPosts">
                    <div className="widget-content">
                        <div className="container fbt-shape-container">
                            <div className="carousel slide card shadow-lg radius-10" data-interval="7500" data-ride="carousel"
                                        ...
                                        <div className="post">
                                            <div className="post-content">
                                                <div className="fbt-item-thumbnail clearfix">
                                                    <a href="./single.html">
                                                        <img alt=" " className="post-thumbnail" src="./images/slide-1.jpg"/>
                                                    </a>
                                                </div>
                                                <div className="card-img-overlay p-0">
                                                    <div className="row align-items-center justify-content-center">
                                                        <div className="col-xl-6 col-9 fbt-title-left">
                                                            <div className="fbt-shape-title fbt-title-caption p-5">
                                                                <h3 className="post-title display-4">
                                                                    <a className="text-white" href="./single.html">
                                                                        Nunc tellus libero, tempus id luctus eget, fermentum.
                                                                    </a>
                                                                </h3>
                                                                <div className="post-meta">
                                                                    <span className="post-author text-white">fbtemplates</span>
                                                                    <span className="post-date published text-white">June 05, 2019</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-xl-4 col-1 fbt-title-right"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="carousel-item">
                                        <div className="post">
                                            <div className="post-content">
                                                <div className="fbt-item-thumbnail clearfix">
                                                    <a href="./single.html">
                                                        <img alt=" " className="post-thumbnail" src="./images/slide-2.jpg"/>
                                                    </a>
                                                </div>
                                                <div className="card-img-overlay p-0">
                                                    <div className="row align-items-center justify-content-center">
                                                        <div className="col-xl-6 col-9 fbt-title-left">
                                                            <div className="fbt-shape-title fbt-title-caption p-5">
                                                                ...
                                                                <div className="post-meta">
                                                                    <span className="post-author text-white">fbtemplates</span>
                                                                    <span className="post-date published text-white">March 31, 2017</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-xl-4 col-1 fbt-title-right"></div>
                                    ...
                                    <div className="carousel-item">
                                        <div className="post">
                                            <div className="post-content">
                                                <div className="fbt-item-thumbnail clearfix">
                                                    <a href="./single.html">
                                                        <img alt=" " className="post-thumbnail" src="./images/slide-3.jpg"/>
                                                    </a>
                                                </div>
                                                <div className="card-img-overlay p-0">
                                                    <div className="row align-items-center justify-content-center">
                                                        <div className="col-xl-6 col-9 fbt-title-left">
                                                            <div className="fbt-shape-title fbt-title-caption p-5">
                                                                ...
                                                                <div className="post-meta">
                                                                    <span className="post-author text-white">fbtemplates</span>
                                                                    <span className="post-date published text-white">March 30, 2017</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-xl-4 col-1 fbt-title-right"></div>
                                ...
                                <a className="carousel-control-prev" data-slide="prev" href="#carouselPopularPosts" role="button">
                                    <span aria-hidden="true" className="carousel-control-prev-icon"></span>
                                    <span className="sr-only">Previous</span>
                                </a>
                                <a className="carousel-control-next" data-slide="next" href="#carouselPopularPosts" role="button">
                                    <span aria-hidden="true" className="carousel-control-next-icon"></span>
                                    <span className="sr-only">Next</span>
                                </a>
                                <ol className="carousel-indicators">
                                    <li data-target="#carouselPopularPosts" data-slide-to="0" className="active"></li>
                                    <li data-target="#carouselPopularPosts" data-slide-to="1" className=""></li>
                                    <li data-target="#carouselPopularPosts" data-slide-to="2" className=""></li>
                                </ol>
                            </div>
                        </div>
                    </div>
