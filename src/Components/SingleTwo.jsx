...
export default function SingleTwo() {
  ...
  return (
    ...
    <div id="page-wrapper" className="full-page item-view">
                        ...
                        <div id="main-wrapper">
                            <div className="main-section" id="main_content">
                                ...
                                <div className="blog-posts fbt-item-post-wrap">
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col-lg-7">
                                                    <div className="fbt-shape-container">
                                                        <div className="shadow-lg radius-10 embed-responsive embed-responsive-16by9">
                                                            <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/zpOULjyy-n8"></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="container">
                                        <div className="row justify-content-center background-light">
                                            <div className="col-xl-8 col-lg-9">
                                            ...
                                            <div id="BlogArchive1_ArchiveList">
                                                <ul className="flat list-unstyled">
                                                    <li className="archivedate">
                                                        <a href="#">June<span
                                                                className="post-count float-right badge badge-primary">2</span></a>
                                                    </li>
                                                    <li className="archivedate">
                                                        <a href="#">September<span
                                                                className="post-count float-right badge badge-primary">1</span></a>
                                                    </li>
                                                    <li className="archivedate">
                                                        <a href="#">May<span
                                                                className="post-count float-right badge badge-primary">1</span></a>
                                                    ...
                                                    <li className="archivedate">
                                                        <a href="#">March<span
                                                                className="post-count float-right badge badge-primary">26</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
